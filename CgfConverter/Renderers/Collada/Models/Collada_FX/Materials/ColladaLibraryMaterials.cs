...
namespace CgfConverter.Renderers.Collada.Collada.Collada_FX.Materials
{
    ...
    [XmlRoot(ElementName = "library_materials", Namespace = "http://www.collada.org/2005/11/COLLADASchema", IsNullable = true)]
    public partial class ColladaLibraryMaterials
    {
        [XmlAttribute("id")]
        public string ID;
