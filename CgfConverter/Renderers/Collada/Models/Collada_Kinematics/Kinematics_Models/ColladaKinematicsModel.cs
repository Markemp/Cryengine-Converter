...
[XmlRoot(ElementName = "kinematics_model", Namespace = "http://www.collada.org/2005/11/COLLADASchema", IsNullable = true)]
public partial class ColladaKinematicsModel
{
    [XmlAttribute("id")]
    public string ID;
    ...
    public ColladaTechniqueCommonKinematicsModel Technique_Common;
