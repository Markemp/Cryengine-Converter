...
//            //REGISTERS
//            Vector4
//                v0 = new Vector4(0, 0, 0, 0),
//                v1 = new Vector4(0, 0, 0, 0),
//                v2 = new Vector4(0, 0, 0, 0),
//                v3 = new Vector4(0, 0, 0, 0),
//                v4 = new Vector4(0, 0, 0, 0),
//                v5 = new Vector4(0, 0, 0, 0);
//            Vector4
//                r0 = new Vector4(0, 0, 0, 0),
//                r1 = new Vector4(0, 0, 0, 0),
//                r2 = new Vector4(0, 0, 0, 0),
//                r3 = new Vector4(0, 0, 0, 0);
//            Vector4
//                o0 = new Vector4(0, 0, 0, 0),
//                o1 = new Vector4(0, 0, 0, 0),
//                o3 = new Vector4(0, 0, 0, 0),
//                o4 = new Vector4(0, 0, 0, 0),
//                o5 = new Vector4(0, 0, 0, 0);
//            Vector3 o2 = new Vector3();

//            Vector4 InstanceBufferRaw0 = new Vector4(1, 0, 0, 31.85579f);
//            Vector4 InstanceBufferRaw1 = new Vector4(0, 1, 0, -17.761f);
//            Vector4 InstanceBufferRaw2 = new Vector4(0, 0, 1, 12.2023f);
...
//            r3.x = new Vector3(InstanceBufferRaw0.x, InstanceBufferRaw0.y, InstanceBufferRaw0.z).Dot(new CryEngineCore.Components.Vector3(r1.x, r1.y, r1.z)); if (debug) Console.WriteLine("39: r3.x: {0}", r3.x);//r3.x = dot(InstanceBuffer[r2.x]._m00_m01_m02, r1.xyz);
//            r3.y = new Vector3(InstanceBufferRaw1.x, InstanceBufferRaw1.y, InstanceBufferRaw1.z).Dot(new CryEngineCore.Components.Vector3(r1.x, r1.y, r1.z)); if (debug) Console.WriteLine("40: r3.y: {0}", r3.y);//r3.y = dot(InstanceBuffer[r2.x]._m10_m11_m12, r1.xyz);
//            r3.z = new Vector3(InstanceBufferRaw2.x, InstanceBufferRaw2.y, InstanceBufferRaw2.z).Dot(new CryEngineCore.Components.Vector3(r1.x, r1.y, r1.z)); if (debug) Console.WriteLine("41: r3.z: {0}", r3.z);//r3.z = dot(InstanceBuffer[r2.x]._m20_m21_m22, r1.xyz);
//            r0.y = new Vector3(new CryEngineCore.Components.Vector3(r3.x, r3.y, r3.z)).Dot(new CryEngineCore.Components.Vector3(r3.x, r3.y, r3.z)); if (debug) Console.WriteLine("42: r0.y: {0}", r0.y);//r0.y = dot(r3.xyz, r3.xyz);
